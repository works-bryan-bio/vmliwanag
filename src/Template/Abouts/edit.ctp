...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><?= $this->Html->link("<i class='fa fa-globe'></i>" . __('About'), ['action' => 'index'],['escape' => false]) ?></li>
    ...
    <div class="row">
        <section class="col-lg-12 ">
            <div class="box " >
                ...
                <div class="box-body">
                    <?= $this->Form->create($about,['id' => 'frm-default-add', 'data-toggle' => 'validator', 'role' => 'form','class' => 'form-horizontal']) ?>
                    <fieldset>        
                        <?php
                                                            echo "
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-sm-6'>";
                                        echo $this->Form->select('is_publish',["1" => "Yes", "0" => "No"],['default' => $about->is_publish, 'class' => 'form-control', 'id' => 'is_publish', 'label' => false]);
                                    echo " </div></div>";    
                    ...
                    <div class="form-group" style="margin-top: 80px;">
                        <div class="col-sm-offset-2 col-sm-10">     
                            ...
                            <?= $this->Html->link('<i class="fa fa-search-plus"> </i> ' . __('Preview'), ['action' => $about->id, $slug],['class' => 'btn btn-warning', 'escape' => false, 'target' => '_new']) ?>                            
