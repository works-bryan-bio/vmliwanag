...
<header class="main-header">
    ...
    <a href="<?= $base_url; ?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b><?= $this->Html->image('logo-small.png',["height"=>"35","width"=>"35"]) ?></b></span>        
      <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b><?= $this->Html->image('logo.png',["height"=>"40","width"=>"180"]) ?></b></span>        
    </a>
