...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b><?= $this->Html->image('logo.jpg',["height"=>"80","width"=>"360"]) ?></b></a>    
  </div>
  <!-- /.login-logo -->
    ...
    <?= $this->Form->create() ?>
        <div id="login-container">
            <div class="form-group has-feedback">
                <?= $this->Form->input('username',["value" => $username, "autofocus" => "autofocus","class" => 'form-control', "placeholder" => "Username", "label" => false])?>                         
            ...
            <div class="row">
                <div class="col-xs-8">
                    ...
                    <label>
                      <input type="checkbox" <?php echo( trim($username) != "" ? 'checked="checked"' : "" ); ?> name="remember_me"> Remember me                      
                    </label>
                    </div>
                </div>
                <!-- /.col -->
