...
class ProductCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 110, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'lft' => 1,
            'rght' => 1,
            'created' => '2017-07-24 11:56:56',
            'modified' => '2017-07-24 11:56:56'
        ],
    ];
}
