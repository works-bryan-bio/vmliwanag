                        ...
                        <?php
                            if( $productCategoryParent ){
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-sm-6'>";
                                    echo $this->Form->input('parent_category', ['class' => 'form-control', 'id' => 'parent_category', 'readonly' => 'readonly', 'disabled' => 'disabled', 'value' => $productCategoryParent->name, 'label' => false]);                
                                echo " </div></div>";
                            }
                            echo "
                            <div class='form-group'>
                        ...
                        <div class="col-sm-offset-2 col-sm-10">                            
                            ...
                            <?php 
                                if( !empty($productCategoryParent) ){
                                    echo $this->Html->link('<i class="fa fa-angle-left"> </i> ' . __('Back To list'), ['action' => 'index', $productCategoryParent->id],['class' => 'btn btn-warning', 'escape' => false]);
                                }else{
