                    ...
                    <fieldset>        
                        <?php
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-6'>";
                                echo $this->Form->select('is_publish',["1" => "Yes", "0" => "No"],['default' => $product->is_publish, 'class' => 'form-control', 'id' => 'is_publish', 'label' => false]);                                        
                            echo " </div></div>";    
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-6'>";
                                echo $this->Form->select('is_featured',["1" => "Yes", "0" => "No"],['default' => $product->is_featured, 'class' => 'form-control', 'id' => 'is_featured', 'label' => false]);                                        
                            echo " </div></div>";    
                        ?>
                    </fieldset>
