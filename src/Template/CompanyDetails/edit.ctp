                    ...
                    <fieldset>                          
                        <?php
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-6'>";
                                echo $this->Form->input('email', ['type' => 'text', 'class' => 'form-control', 'id' => 'email', 'label' => false]);                
                            echo " </div></div>";    
                            ...
                            echo " </div></div>";    
                        ?>
                        <h3 style="background-color:#3C8DBC;color:#ffffff;padding:10px;">Social Media</h3>
                        <?php 
                            echo "
                            <div class='form-group'>
                                <label for='facebook' class='col-sm-2 control-label'>" . __('Facebook') . "</label>
                                <div class='col-sm-6'>";
                            ...
                            echo "
                            <div class='form-group'>
                                <label for='twitter' class='col-sm-2 control-label'>" . __('Twitter') . "</label>
                                <div class='col-sm-6'>";
